      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
        {artifact.options.map((option) => (
          <button
            ...
            className="text-left bg-paper-3/50 border border-line-2 rounded-lg p-3 transition-all duration-200 hover:border-sky hover:bg-paper-3 focus:outline-none focus:ring-2 focus:ring-moss/40"
          >
