-- =============================================================================
-- Migration 001: Capability Upgrades (Epics 1, 2, 4)
--
...
-- NOTE: No explicit BEGIN/COMMIT — the postgres.js driver wraps sql.begin()
-- around the entire migration in the runner. Using BEGIN here would trigger
-- UNSAFE_TRANSACTION errors.
