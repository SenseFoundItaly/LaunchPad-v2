    ...
    <div className="h-full overflow-y-auto p-6">
      <div className="max-w-4xl mx-auto">
        <div className="flex items-center justify-between mb-6">
          <h3 className="text-lg font-semibold text-ink">Validation Scoring</h3>
          <button
            onClick={runScoring}
            disabled={isRunning}
        ...
        {scores && (
          <>
            <div className="bg-paper-2 border border-line rounded-xl p-6 mb-6 flex flex-col items-center">
            ...
            {scores.top_recommendation && (
              <div className="bg-sky-wash border border-sky/30 rounded-xl p-4 mb-6">
                <h4 className="text-sm font-medium text-sky mb-1">Top Recommendation</h4>
        ...
        {!scores && !isRunning && !loading && (
          <div className="text-center py-20 text-ink-5">
            <p>Score your idea across 6 evidence-based dimensions.</p>
            <p className="text-sm mt-1">Complete the Idea step first so SenseFound has data to validate against.</p>
          </div>
        )}
      </div>
    </div>
