...
export default function JourneyPage({
  ...
  function milestoneStatusIcon(status: Milestone['status']) {
    switch (status) {
      case 'completed':
        return { icon: '\u2713', cls: 'bg-moss text-on-accent' };
      case 'in_progress':
        return { icon: '\u25B6', cls: 'bg-moss text-on-accent' };
      case 'skipped':
        return { icon: '\u2014', cls: 'bg-ink-6 text-ink-4' };
      default:
        return { icon: '\u25CB', cls: 'bg-paper-3 text-ink-5' };
    }
  }
    ...
    <div className="h-full overflow-y-auto p-6">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-6">
          <h3 className="text-lg font-semibold text-ink">Validation Journey</h3>
        </div>
        ...
        {activeTab === 'timeline' && (
          <div>
            {/* Stage Selector */}
            <div className="bg-paper-2 border border-line rounded-xl p-4 mb-6">
                        ...
                        className={`px-4 py-2 rounded-lg text-sm font-medium transition-colors ${
                          isCurrent
                            ...
                            : isPast
                              ...
                              : 'bg-paper-3 text-ink-5 hover:bg-ink-6 hover:text-ink-3'
                        }`}
                      >
                        {STAGE_LABELS[stage]}
                      </button>
                ...
                {milestones.map((milestone) => {
                  ...
                  return (
                    <div
                      ...
                      className="bg-paper-2 border border-line rounded-xl p-4 flex items-start gap-4"
                    >
                      <button
          ...
          <div>
            <div className="flex justify-end gap-2 mb-4">
              <button
                ...
                disabled={isRunning}
                className="px-4 py-2 bg-paper-3 hover:bg-ink-6 disabled:bg-paper-3 text-ink-3 rounded-lg text-sm font-medium transition-colors"
              >
            ...
            {showUpdateForm && (
              <div className="bg-paper-2 border border-line rounded-xl p-6 mb-6">
                <h4 className="text-sm font-medium text-ink mb-4">New Progress Update</h4>
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      rows={3}
                      className="w-full bg-paper-3 border border-line-2 rounded-lg px-3 py-2 text-sm text-ink focus:outline-none focus:border-moss resize-none"
            ...
            {updates.length > 0 ? (
                  ...
                  >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                      ...
                      {update.asks && update.asks.length > 0 && (
                        <div>
                          <h5 className="text-xs font-medium text-sky mb-1">Asks</h5>
                          <ul className="space-y-0.5">
                            {update.asks.map((a, i) => (
                              <li key={i} className="text-xs text-ink-3">
                                - {a}
                    ...
                    {update.generated_summary && (
                      <div className="mt-3 bg-paper-3/50 rounded-lg p-3">
              ...
              <div className="text-center py-12 text-ink-5 text-sm">
                No updates yet. Log your first progress update to build an evidence trail.
              </div>
            )}
          </div>
        )}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {scalingPlan.months.map((month) => (
                  ...
                  >
                    ...
                    <div className="bg-paper-3/50 rounded-lg px-3 py-2 mb-3">
