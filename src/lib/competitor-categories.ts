...
import {
  ...
  type CompetitorWithCategories,
} from './competitor-categories.shared';

// Re-export the client-safe taxonomy/labels/types so existing SERVER importers of
// '@/lib/competitor-categories' keep resolving. CLIENT components must import
// from './competitor-categories.shared' directly (this module pulls in postgres).
export { CATEGORY_LABEL_KEY } from './competitor-categories.shared';
export { COMPETITOR_CATEGORIES, categoryForColumn, normalizeCategory };
export type { CompetitorCategory, CompetitorCategoryRow, CompetitorWithCategories };
