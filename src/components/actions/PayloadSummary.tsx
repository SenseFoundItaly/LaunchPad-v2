...
function displayValue(v: unknown, t: ReturnType<typeof useT>): string | null {
  ...
  if (Array.isArray(v)) {
    ...
    return v.length === 1 ? t('spr.items-see-raw-one') : t('spr.items-see-raw-many', { n: v.length });
  }
  if (typeof v === 'object') {
