  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="inline-flex items-center gap-1.5 px-4 py-2 text-sm font-medium text-paper bg-moss rounded-lg transition-all duration-200 hover:bg-moss/80 focus:outline-none focus:ring-2 focus:ring-moss/40"
      >
