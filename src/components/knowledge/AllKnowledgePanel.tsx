...
const KIND_GROUPS: Array<{ kind: KnowledgeKind; labelKey: MessageKey; labelLowerKey: MessageKey }> = [
...
const TIER_BADGE: Record<ProvenanceTier, { labelKey: MessageKey; kind: 'n' | 'info' | 'ok' }> = {
...
const STORE_HINT: Record<KnowledgeSourceStore, MessageKey> = {
